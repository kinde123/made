...
id = "mainNav" >
    ...
    a className = "navbar-brand"
                    href="Oferta.html" > <img src="assets/images/logo1.png" classNameName="img-responsive" style={{'width':'100%', height:'auto', maxWidth:250}} alt="logo" /> < /a> <
    button
...
href = "Oferta.html"
style={{color:'white',}} > Oferta < /a> <
    /li> <
    li className = "nav-item" >
    <
    a className = "nav-link"
href = "Panelarchitekta.html"
style = {{color:'white',}} > Panel Architekta < /a> <
    /li> <
    li className = "nav-item" >
    <
    a className = "nav-link"
href = "newsroom.html"
style ={{color:'white',}} > Newsroom < /a> <
    /li> <
    li className = "nav-item" >
    <
    a className = "nav-link"
href = "wnetrza3D.html"
style = {{color:'white',}}> Wnetrza3D < /a> <
    /li> <
    li className = "nav-item" >
    <
    a className = "nav-link"
href = "Kontact"
style = {{color:'white'}} > Kontact < /a> <
    /li> <
    /ul>
